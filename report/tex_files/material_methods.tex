...
\subsection{Robustez}
Por último, se ha calculado la robustez de la red de genes. La robustez funciona para conocer si la red que se está estudiando es un sistema fuerte y esta no tiende a tener errores.
Para realizar este apartado, se ha utilizado los métodos proporcionados en el campus virtual. La robustez ha sido calculada frente a ataques aleatorios como a ataques dirigidos, pero también, han sido combinados ambos ataques.
